...
import { Calendar, MapPin, Clock, Radio, Globe } from 'lucide-react'
...
export default function AssignerDashboard() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <p className="text-sm text-slate-400">Assigner</p>
              ...
              <div key={t.id} className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <Link href={`/tournaments/${t.id}`} className="font-semibold text-slate-800 hover:text-teal-700 block truncate">{t.name}</Link>
