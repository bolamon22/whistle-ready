...
import {
  ...
  ShieldCheck, Check, ArrowRight, Search, MapPin, Trophy, Loader2, LogIn,
  Eye, Flag, UserRound, UserCog,
} from 'lucide-react'
...
export default function Landing() {
  ...
  return (
    ...
    <div className="-m-6 bg-white text-slate-800">
      ...
      <header className="sticky top-0 z-40 bg-white/85 backdrop-blur border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-7 text-sm font-medium text-slate-600">
            ...
            <a href="#features" className="hover:text-slate-900 transition-colors">What we do</a>
      ...
      {/* ── HERO: product pitch + search up top ── */}
      <section className="px-6 pt-16 pb-12" style={{ background: 'radial-gradient(1100px 480px at 80% -12%, #f0fdfa, transparent)' }}>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-600 max-w-xl mx-auto mb-8">
            Registration, divisions and brackets, scheduling, staff and payouts, live scores, and public standings — the entire event on one system.
          </p>

          {/* Find your tournament — up top */}
          <div className="max-w-xl mx-auto bg-white border border-slate-200 rounded-2xl shadow-[0_12px_40px_-16px_rgba(15,23,42,0.2)] p-4 sm:p-5 text-left">
            <div className="flex items-center gap-2 text-sm font-semibold text-slate-700 mb-2.5 px-1">
              <Trophy className="w-4 h-4 text-teal-600" /> Find your tournament
            </div>
            <div className="relative">
              ...
              <input
                ...
                className="w-full border border-slate-300 rounded-xl pl-11 pr-4 py-3.5 text-sm focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-100 transition-colors"
              />
            </div>
            <div className="flex items-center justify-between mt-2.5 px-1">
              <span className="text-xs text-slate-400">Live schedules, standings, and brackets — no account needed.</span>
              <a href="#tournaments" className="text-xs font-semibold text-teal-700 hover:text-teal-900 inline-flex items-center gap-1 whitespace-nowrap">
      ...
      {/* ── TOURNAMENT RESULTS (search target) ── */}
      <section id="tournaments" className="px-6 pb-16 scroll-mt-20">
        <div className="max-w-4xl mx-auto">
          {all === null ? (
            ...
            hasSearch ? (
              <p className="text-center text-slate-500 py-6">No events match “{query}”.</p>
            ) : (
              <div className="text-center border border-dashed border-slate-300 rounded-xl py-12">
      ...
      {/* ── WHAT WE DO (app information) ── */}
      <section id="features" className="px-6 py-20 bg-slate-50 border-y border-slate-200 scroll-mt-20">
      ...
      <footer className="px-6 py-10 border-t border-slate-200">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-slate-500">
            ...
            <a href="#features" className="hover:text-slate-800 transition-colors">What we do</a>
